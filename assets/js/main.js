(function ($) {
  ...
  $(document).ready(function ($) {
    ...
    $(".testimonial-carousel").owlCarousel({
      ...
      mouseDrag: false,
      navText: [
        "<img src='assets/img/testimonial/left.png'>",
        "<img src='assets/img/testimonial/right.png'>",
      ],
    });
    ...
    $(".recent-post-slider").owlCarousel({
      ...
      mouseDrag: false,
      navText: [
        "<img src='assets/img/testimonial/left-arrow.png'>",
        "<img src='assets/img/testimonial/right-arrow.png'>",
      ],
      responsive: {
        1200: {
          items: 1,
    ...
    $(window).on("scroll", function () {
      ...
      if (scroll > footerOffset) {
        ...
        $(".footer")
          .find(".footer-bottom")
          .find(".back-to-top-btn")
          .find("a")
          .addClass("active-plus");
      } else {
...
function toggleResponsiveClass() {
  ...
  if (window.innerWidth < 768) { // Example breakpoint for responsiveness
    tagElement.classList.add('tag-responsive');
  } else {
    tagElement.classList.remove('tag-responsive');
  }
}

// Initial call to set class based on initial viewport size
